...
1. **One signature interaction — named, unforgettable, on the make-or-break surface.** A load-time fade is not it. The signature is a scroll-driven reveal, a spatial moment, a kinetic type beat, a magnetic pull — something a stranger remembers and describes. If you can remove it and the page loses nothing, it was decoration, not signature. This is the single strongest predictor of 8+.
