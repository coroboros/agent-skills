...
Loads at truth sourcing (step 7, where each imperative's layers are secured), binds at the build step, and is gated at the verify phase and the review. The per-archetype files refine *how* each imperative expresses; this file is the floor under all of them.
