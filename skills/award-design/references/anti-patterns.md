...
- Eyebrow that restates the H1 below it — "SMALL EXPEDITIONS · THE GEOGRAPHIC NORTH POLE" over an H1 that already says the same, "Our services" over "What we do". An eyebrow earns its place by supplying context the headline lacks (a category, a keyword, the reader's place in the page); one that repeats the subject the H1 already carries is redundant and reads as filler. If the H1 stands alone, cut the eyebrow.
