...
**Section chain** — the winner-verified roles with their intensity map and the state each owes. Build each role as its row describes; never improvise the hero or a section layout outside the chain.
