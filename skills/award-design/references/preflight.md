...
| [ ] **Motion continuity** | zero fully-static sections in the default render, footer included — every section runs the signature vocabulary at ≥ micro amplitude, `n/n` cited; the footer closes on the live signature | Global — a page that goes still after the hero fails however strong the hero is |
