...
- During step 2 (Recommend an archetype): share 2–3 exemplars alongside the recommendation so the user can visually confirm the fit.
...
- When writing the DESIGN.md: these sites are fair game as visual references for the Visual Theme section ("atmosphere in the spirit of [brand]").
