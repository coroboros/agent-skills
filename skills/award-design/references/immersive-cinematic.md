...
**Figures / cards**
- **Inner scale 1.1** — the image scales to `1.1` inside a fixed frame that clips the overflow. Lando `.helmet-grid-item:hover img`; Siena `.previousnext-item:hover .full-img-w`. Amplitude is 10%, never a dead `1.03` — the default media hover (Lando, SOTY 2025; Siena, SOTD Mar 2025).
...
Corpus — Lando Norris (SOTY 2025, live), Siena Film Foundation (SOTD Mar 2025 + Developer Award, live), Lusion v3 (SOTD Oct 2023, live), Messenger (SOTD Nov 2025, `messenger.abeto.co` — media-only), Active Theory (live chrome; copy canvas-rendered; award unverified).
