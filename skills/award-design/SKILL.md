...
**Load now:** `references/external-truth.md` + `references/imagery.md` + `references/award-imperatives.md` + `references/motion-palette.md` + `references/text-effects.md` + `references/interaction-signatures.md`.
