...
### Bias toward
- Warm undertones in every neutral — if a gray reads cool, swap it
- Serif for headlines, sans for UI — never reverse the split
- Ring shadows (`0px 0px 0px 1px`) on a warm ring color, not drop shadows
- Generous line-height (1.60) on body copy — reading rhythm over density
- Light/dark section alternation to create chapter rhythm
- Organic, hand-drawn-feeling illustrations over geometric vectors
- Weight 500 on Anthropic Serif — a single-weight voice across all headings

### Reject
- Cool blue-grays anywhere — every neutral carries yellow-brown warmth
- Pure white page backgrounds — Parchment (`#f5f4ed`) is the floor
- Bold weights (700+) on Anthropic Serif — 500 is the ceiling
- Saturated colors beyond Terracotta — the palette is muted by design
- Sharp corners under 6px on primary surfaces
- Geometric / tech-style illustrations
- Sans-serif at headline sizes — the serif owns display

### Self-test question
"Does this feel like a book page or a tech product?" If it reads as tech, the type is too cold, the shadows too hard, or the background too white. Warm every surface until the answer is unmistakably editorial.
