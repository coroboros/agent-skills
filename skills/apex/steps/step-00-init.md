...
2. **Once resolved:**
   ...
   - Load the step file of the first non-✓ row (`steps/step-03b-refine.md` for `03b-refine`, otherwise the file for `{step_num}`) — the Progress table is authoritative; every step writes its row on completion.
