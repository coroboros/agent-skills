...
UPSTREAM_REF = REPO_ROOT / "skills" / "code-ultrareview" / "references" / "derivation.md"
...
class TestDerivationLensReference(unittest.TestCase):
    ...
    def test_reference_cites_upstream_canonical(self):
        """Reference cites code-ultrareview's derivation.md as canonical taxonomy."""
        self.assertIn(
            "code-ultrareview/references/derivation.md",
            self.ref,
